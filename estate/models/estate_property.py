...
class EstateProperty(models.Model):
    ...
    expected_price = fields.Float("Expected Price", required=True,tracking=True,compute='_compute_total_area',digits='Property Expected Price')
    selling_price = fields.Float("Selling Price", copy=False, readonly=True,tracking=True,digits='Property selling Price')
    ...
    price_per_m = fields.Float("Price per sqm", copy=False,tracking=True)
    ...
    @api.depends("living_area", "garden_area","price_per_m")
    def _compute_total_area(self):
        for prop in self:
            prop.total_area = prop.living_area + prop.garden_area
            prop.expected_price = prop.total_area * prop.price_per_m
